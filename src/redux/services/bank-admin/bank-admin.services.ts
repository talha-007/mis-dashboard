...
// --- Stats ---
const getStats = (params?: { period?: string; startDate?: string; endDate?: string }) =>
  callAPi.get('/api/v1/stats/bank-admin', { params });
...
const deleteEmployee = (id: string) => callAPi.delete(`/api/v1/bankAdmin/employees/${id}`);
