...
export function AssessmentView() {
  ...
  const fetchAssessment = useCallback(async () => {
    try {
      setLoading(true);
      setError(null);
      const res = await assessmentService.getBankAssessment();
  ...
  return (
    <DashboardContent>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
        ...
        option. Add as many questions as you need. Add <strong>custom fields</strong> for
        income/expense values the customer enters (no score).
      </Typography>
