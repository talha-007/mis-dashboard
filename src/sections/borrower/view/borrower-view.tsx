...
import { _borrowers } from 'src/_mock/_borrower';
          ...
          <TableContainer sx={{ overflow: 'unset' }}>
            <Table sx={{ minWidth: 800 }}>
              <BorrowerTableHead
                ...
                rowCount={_borrowers.length}
                numSelected={table.selected.length}
                onSort={table.onSort}
                onSelectAllRows={(checked) =>
                  table.onSelectAllRows(
                    checked,
                    _borrowers.map((borrower) => borrower.id)
                  )
                }
                headLabel={[
              ...
              <TableBody>
                ...
                <TableEmptyRows
                  height={68}
                  emptyRows={emptyRows(table.page, table.rowsPerPage, _borrowers.length)}
                />
